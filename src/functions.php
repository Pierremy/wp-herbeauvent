...
class WS_Starter extends TimberSite {
   ...
   public function custom_options_page()
   {
      ...
      // Socials
      $socials = acf_add_options_page(array(
         'page_title'  => __('Social Icons'),
         'menu_title'  => __('Social Icons'),
         'menu_slug'   => 'ws-options-socials',
         'parent_slug' => $parent['menu_slug']
      ));
   ...
   public function add_to_context($context) {
      $context['woocommerce'] = WC();
		$context['woocommerce_account_link'] = get_permalink(get_option('woocommerce_myaccount_page_id'));
		$context['woocommerce_cart_link'] = wc_get_cart_url();
		$context['WC_AJAX_CART'] = WC_AJAX::get_endpoint('add_to_cart');
